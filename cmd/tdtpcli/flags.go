...
func ParseFlags() *Flags {
	...
	f.Stream = flag.Bool("stream", false, "[BETA] Stream the export: read, pack and write part by part instead of loading the whole table (SQLite, MSSQL, MySQL; requires --output, no S3)")
