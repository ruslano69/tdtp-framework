...
**Версия:** 1.3.1 (базовый протокол v1.0; расширения: v1.2 — compression, v1.3 — encryption, v1.3.1 — compact format / fixed fields / special values, v1.4 — integrity xxh3_128 hashes + xzMercury)
**Дата:** 26.05.2026
